...
public class CheckersPieceFactory {
    private final CheckersMovementFactory checkersMovementFactory;
    private static int ID;

    public CheckersPieceFactory() {
        this.checkersMovementFactory = new CheckersMovementFactory();
    }
    ...
    private Piece createPawn(Colour colour, Tile initialPosition) {
        return Piece.builder()
                ...
                .pieceId("pawn")
                .pieceMover(checkersMovementFactory.createPawnMovements(colour))
                .build();
    }
}
