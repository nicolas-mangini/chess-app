...
public class ChessPieceBuilder implements PieceBuilder {
    ...
    private Piece createPawn(Colour colour, Tile initialPosition) {
        return Piece.builder()
                ...
                .pieceMovementsValidator(chessValidatorBuilder.createPawnMovements(colour))
                .build();
    }
    ...
    private Piece createRookW1() {
        return Piece.builder()
                ...
                .pieceMovementsValidator(chessValidatorBuilder.createRookMovements())
                .build();
    }
    ...
    private Piece createKnightW1() {
        return Piece.builder()
                ...
                .pieceMovementsValidator(chessValidatorBuilder.createKnightMovements())
                .build();
    }
    ...
    private Piece createBishopW1() {
        return Piece.builder()
                ...
                .pieceMovementsValidator(chessValidatorBuilder.createBishopMovements())
                .build();
    }
    ...
    private Piece createQueenW1() {
        return Piece.builder()
                ...
                .pieceMovementsValidator(chessValidatorBuilder.createQueenMovements())
                .build();
    }
    ...
    private Piece createKingW1() {
        return Piece.builder()
                ...
                .pieceMovementsValidator(chessValidatorBuilder.createKingMovements())
                .build();
    }
